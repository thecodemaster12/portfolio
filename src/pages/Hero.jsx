...
const Hero = () => {
  return (
    <>
      <section id="hero" className='bg-[red] sm:bg[blue] md:bg-[green] lg:bg-[yellow] xl:bg-[purple] 2xl:bg-[pink]'>
        <div className="min-h-screen grid md:grid-cols-2 gap-16 md:gap-0 lg:gap-4 place-content-center place-items-center p-6">

            <div className="border flex justify-center text-center md:text-left flex-col">
